...
const InputSendMessage = (props) => {
    ...
    return (
        <div className="w-100 position-relative br32px-bottom ">
            ...
            <form onSubmit={ onFormSubmit} className="w-100 br10px-bottom">
                <div className="position-relative  w-100 br10px-bottom ">
                    ...
                    <textarea placeholder="تایپ کنید ..." className="col-12 text-break inputSendChat form-control pt-2 br32px-bottom " onChange={ onchange}  onKeyDown={ handleKeyDown} value={value} />
