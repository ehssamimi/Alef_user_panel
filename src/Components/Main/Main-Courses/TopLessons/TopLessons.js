...
export default function TopLessons (props){
    ...
    let{name,price,off,chapter_count,owned}=props;
        ...
        <div className='mt-3 w-100  mb-5 ' dir='rtl' >
            <div className='mt-4 w-100' >
                        ...
                        <h3 className="header-color FsHeaderLogin1">{name}</h3>
                        {
                            !owned ?
                                ...
                                <div className="ml-auto row FssubmitLogin">
                                    {
                                        off !== 0 ? <span
                                            className='red-color text-decoration-line-through  mr-2      '>{formatNumber(price)} تومن  </span> : ""
                                    }
                                    {
                                        off !== 0 ? <span
                ...
                <div className="col-12 pl-4 pr-0  pb-2 row FssubmitLogin ">
                    ...
                    {
                        !owned?<div className='Green-dark-color FssubmitLogin d-flex ml-sm-auto pt-2' >
